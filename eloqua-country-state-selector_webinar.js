...
document.addEventListener('DOMContentLoaded', function() {
  ...
  "Bahrain": ["Al 'Asimah", "Ash Shamaliyah", "Al Janubiyah", "Al Muharraq"],
  "Bangladesh": [
    "Barishal",
    "Chattogram",
    "Dhaka",
  ...
  "Chad": [
    ...
    "Madinat Injamina",
    "Mandul",
    "Mayu Kibbi al Gharbi",
    "Mayu Kibbi ash Sharqi",
    "Qira",
    "Salamat",
    "Shari al Awsat",
    "Shari Baqirmi",
  ...
  "Djibouti": ["Ali Sabih", "Arta", "Awbuk", "Dikhil", "Jibuti", "Tajurah"],
  "Dominica": [
    "Saint Andrew",
    "Saint David",
    "Saint George",
  ...
  "Iceland": [
    ...
    "Sveitarfelagid Hornafjordur",
    "Sveitarfelagid Olfus",
    "Sveitarfelagid Skagafjordur",
    "Sveitarfelagid Skagastrond",
    "Sveitarfelagid Vogar",
  ...
  "Mauritania": [
    ...
    "Hodh el Gharbi",
    "Inchiri",
    "Nuwakshut al Gharbiyah",
    "Nuwakshut al Janubiyah",
    "Nuwakshut ash Shamaliyah",
    "Tagant",
    "Tiris Zemmour",
    "Trarza"
  ],
  ...
  "Moldova": [
    ...
    "Falesti",
    "Floresti",
    "Gagauzia, Unitatea teritoriala autonoma (UTAG)",
    "Glodeni",
    "Hincesti",
    "Ialoveni",
    "Leova",
  ...
  "Russian Federation": [
    ...
    "Cukotskij avtonomnyj okrug",
    "Cuvasskaja Respublika",
    "Evrejskaja avtonomnaja oblast'",
    "Habarovskij kraj",
    "Hakasija, Respublika",
    "Hanty-Mansijskij avtonomnyj okrug",
    "Ingusetija, Respublika",
    "Irkutskaja oblast'",
    "Ivanovskaja oblast'",
  ...
  "Togo": ["Centrale", "Kara", "Maritime (Region)", "Plateaux", "Savanes"],
  "Tokelau": [],
  ...
  "Turkmenistan": ["Ahal", "Asgabat", "Balkan", "Dasoguz", "Lebap", "Mary"],
